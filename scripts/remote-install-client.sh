...
usage() {
  cat <<'EOF'
usage: remote-install-client.sh

Downloads the latest portable nvimon release archive, installs the CLI to
~/.local/bin, and creates the default user config if needed.
EOF
}
